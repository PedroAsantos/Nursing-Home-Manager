...
=======
		select exemplo1.PATIENT.NIF, exemplo1.PATIENT.Name, exemplo1.PATIENT.Sex, exemplo1.PATIENT.Phone, exemplo1.PATIENT.Age, exemplo1.PATIENT.Check_in, exemplo1.PATIENT.Check_out, Authorization_to_leave, E_BedNumber, Entry_Date, Exit_Date, RoomNumber, exemplo1.VISITOR.Name as DependentName, exemplo1.VISITOR.CC as DependentCC, exemplo1.VISITOR.Address as DependentAddress, exemplo1.VISITOR.Phone as DependentPhone from exemplo1.PATIENT 
>>>>>>> 3c1464f4d37f59a7f2b5fa3647374ada794d4cdb
